...
description: Universal standard and best practices for structuring sequential data science and research notebook pipelines. Defines the 3-zone notebook architecture, dual Google Colab / Local Drive path resolution, cell comment numbering (# Cell XX), folder bootstrapping, and two-way JSON handshakes. Activate whenever generating, reviewing, or modifying Jupyter notebooks.
---
